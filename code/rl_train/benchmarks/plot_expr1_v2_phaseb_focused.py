"""Plot Expr1 V2 Phase B focused sweep in the same style as the original figure."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot Expr1 V2 Phase B focused summary.")
    parser.add_argument(
        "--summary-json",
        type=str,
    ...
    parser.add_argument(
        "--output-path",
        type=str,
        default="code/data_generated/rl_steane_tune_experiments_V2/expr1_gate_only_v2/phaseB_focused/expr1_v2_phaseB_focused.png",
    )
    parser.add_argument(
        "--figure-title",
        type=str,
        default="Expr1 V2 Phase B Focused Sweep",
    )
...
def main() -> None:
    args = parse_args()
    rows = _load_rows(Path(args.summary_json))
